...
import { injected, walletconnect, walletlink, portis, arkaneconnect, safeApp, fortmatic } from '../connectors'
...
export const SUPPORTED_WALLETS: { [key: string]: WalletInfo } = {
  ...
  FORTMATIC: {
    ...
    description: 'Connect to Fortmatic hosted wallet',
    href: null,
    color: '#315CF5'
  }
}
...
export const DEFAULT_TOKEN_LIST_URL = 'https://unpkg.com/quickswap-default-token-list@1.0.77/build/quickswap-default.tokenlist.json'
