...
export const EGG = new Token(ChainId.MATIC, '0x245e5ddb65eFea6522Fa913229dF1f4957fB2e21', 18, 'EGG', 'LoserchickEgg')
...
export const BASES_TO_TRACK_LIQUIDITY_FOR: ChainTokenList = {
  ...WETH_ONLY,
  [ChainId.MATIC]: [...WETH_ONLY[ChainId.MATIC], RELAY,DAI, USDC, USDT, GHST, QUICK, ETHER, UNITOKEN, IGG, WBTC, OM, MAUSDC, MADAI, DG, SX, FRAX, FXS, MAWETH, MAUSDT, MATUSD, HEX, SWAP, UBT, IFARM, VISION, LINK, CEL, ARIA20, DSLA,SUPER,DEFI5, MONA,WISE,CC10,MOCEAN, WOLF, AGA, AGAr, TEL, GFARM2,AAVE,PLOT,BIFI, QI, MI, POLYDOGE, DEGEN, GAME, ELET,ADDY,QuickChart,PAUTO, UFT,IRON,TITAN,FFF, ELE, PBNB, IOI, ERN, RAMP, RUSD, WBUSD, WOO,START,BUNNY,GBTS,FOR, RDOGE, COMBO, FEAR,MBTM,RENDGB,NEXO,GNO,BEL,SOL,DINO,PYR,YAMP,OMEN,KOGECOIN,MEEB,IMX,AVAX,YEL,PSWAMP,GUARD,ADS,O3,EZ,DNXC,POOL, MOD, EGG, HT, REVV,CIOTX,XCAD,XED,OOE,MOONED,DHV,WOW,ANRX,MASK,RING,TCP,ANGEL,UGT,KOM,UST,LUNA,CNTR,TRADE,PLR,RENBTC,ORBS,SHI3LD,BABYQUICK,PERA,IRIS,XCASH,SNK]
}
...
export const DEFAULT_TOKEN_LIST_URL = 'https://unpkg.com/quickswap-default-token-list@1.1.2/build/quickswap-default.tokenlist.json'
